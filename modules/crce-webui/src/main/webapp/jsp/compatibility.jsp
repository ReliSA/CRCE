        ...
        <div class="upload">
            <table class="upload">
                ...
                <tr>
                    ...
                    <td>
                        <div class="tlac"><input class="tlacitko" type="submit" value="Search"/></div>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <c:otherwise>
            <table>
                ...
                <c:forEach items="${lower}" var="comp">
                    <tr>
                        <td>${comp.baseResourceName}</td>
                        <td>${comp.baseResourceVersion}</td>
                        <td>${comp.diffValue}</td>
                    </tr>
                </c:forEach>
                <tr class="pivot">
                    <td>${pivotName}</td>
                ...
                <c:forEach items="${upper}" var="comp">
                    <tr>
                        <td>${comp.resourceName}</td>
                        <td>${comp.resourceVersion}</td>
                        <%
