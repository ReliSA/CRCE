...
import cz.zcu.kiv.crce.test.plugin.search.impl.central.json.CentralRepoJsonResponse;
import cz.zcu.kiv.crce.test.plugin.search.impl.central.json.JsonArtifactDescriptor;
import cz.zcu.kiv.crce.test.plugin.search.impl.central.json.JsonResponseBody;
import cz.zcu.kiv.crce.test.plugin.search.impl.central.json.JsonResponseHeader;
