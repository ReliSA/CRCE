...
import cz.zcu.kiv.crce.test.plugin2.search.impl.central.json.JsonResponseBody;
import cz.zcu.kiv.crce.test.plugin2.search.impl.central.json.JsonResponseHeader;
