...
import cz.zcu.kiv.crce.rest.client.indexer.config.RequestParamConfig;
import cz.zcu.kiv.crce.rest.client.indexer.config.RequestParamFieldType;
import cz.zcu.kiv.crce.rest.client.indexer.config.WSClientConfig;
import cz.zcu.kiv.crce.rest.client.indexer.config.WSClientDataConfig;
import cz.zcu.kiv.crce.rest.client.indexer.config.WSClientMethodConfig;
import cz.zcu.kiv.crce.rest.client.indexer.config.structures.IWSClient;
import cz.zcu.kiv.crce.rest.client.indexer.config.structures.RequestMethod;
import cz.zcu.kiv.crce.rest.client.indexer.config.structures.RequestParam;
import cz.zcu.kiv.crce.rest.client.indexer.config.structures.SettingsMethod;
import cz.zcu.kiv.crce.rest.client.indexer.config.structures.WSClient;
