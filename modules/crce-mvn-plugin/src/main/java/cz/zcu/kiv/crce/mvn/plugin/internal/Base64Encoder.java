...
/**
 * This class is used by FileUtil.
 */
...
public class Base64Encoder
{
    ...
    @SuppressFBWarnings(value = "DM_DEFAULT_ENCODING", justification = "Adopted 3rd party implementation.")
    ...
    **/
    ...
    @SuppressFBWarnings(value = "SF_SWITCH_NO_DEFAULT", justification = "Adopted 3rd party implementation.")
