		...
		<c:forEach items="${plugins}" var="plugin">
			<div class="komponenta">
	  			...
	  			<div class="informace">
	  				...
	  				<div class="polozka"><strong>Priority:</strong> ${plugin.pluginPriority} <a class="edit" href="edit?type=editPlugin&plugId=${plugin.pluginId}" title="edit plugin priority">[edit]</a></div>
	  				<div class="polozka"><strong>Version:</strong> ${plugin.pluginVersion} <a class="edit" href="edit?type=editPlugin&plugId=${plugin.pluginId}" title="edit plugin version">[edit]</a></div>
