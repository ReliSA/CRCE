...
public interface RestimplMetadataConstants {
    ...
    AttributeType<String> ATTR__RESTIMPL_FRAMEWORK =
            new SimpleAttributeType<>("framework", String.class);
    ...
    ListAttributeType ATTR__RESTIMPL_ENDPOINT_ENDPOINT_DEPENDENT =
            new ListAttributeType("dependentOn");
    ...
    AttributeType<String> ATTR__RESTIMPL_DATETYPE =
            new SimpleAttributeType<>("datetype", String.class);
    AttributeType<String> ATTR__RESTIMPL_DEFAULT_VALUE =
            new SimpleAttributeType<>("defaultValue", String.class);
    AttributeType<String> ATTR__RESTIMPL_PARAMETER_CATEGEORY =
    ...
    AttributeType<Long> ATTR__RESTIMPL_OPTIONAL =
            new SimpleAttributeType<>("isOptional", Long.class);

    AttributeType<Long> ATTR__RESTIMPL_RESPONSE_STATUS =
            new SimpleAttributeType<>("status", Long.class);
