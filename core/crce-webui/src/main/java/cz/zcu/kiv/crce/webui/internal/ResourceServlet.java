...
public class ResourceServlet extends HttpServlet {
    ...
    // see namespace package in crce-metadata-osgi-bundle
    // same variables are declared there
...
//                    plugins = Activator.instance().getPluginManager().getPlugins(Plugin.class, filter);
            ...
            case "compatibility": {
                ...
                Requirement resFilter = Activator.instance().getMetadataFactory().createRequirement(OSG_IDENTITY_NAMESPACE);
                resFilter.addAttribute(ATTRIBUTE_SYMBOLIC_NAME, name);
                Version v = new Version(version);
                resFilter.addAttribute(ATTRIBUTE_VERSION, v);
